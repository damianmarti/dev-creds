...
function DeveloperRow({ developer }: { developer: DeveloperResult }) {
  return (
    <div className="w-full p-4 transition-colors hover:bg-base-200/50 md:grid md:grid-cols-10 md:items-center md:gap-4 border border-base-200 md:rounded-none md:border-0">
